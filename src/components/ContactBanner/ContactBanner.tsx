    ...
    <>
      <section className={`w-full flex flex-col items-center mb-9`}>
        ...
        <div className={`flex justify-center gap-4 w-1/12`}>
          <a href="mailto:zorer.salih@gmail.com">
            <div
              className={` w-10 h-10 flex justify-center items-center rounded-full ${theme.siteBackground} ${theme.inputBorder} border-solid border-2`}
            >
              <img src={EmailLogo} alt="Email" className={` w-4 `} />
            </div>
          </a>
          <a href="https://www.linkedin.com/in/zorersalih/">
            <div
              className={` w-10 h-10 flex justify-center items-center rounded-full ${theme.siteBackground} ${theme.inputBorder} border-solid border-2`}
            >
          ...
          <a href="https://github.com/zorro-ftw">
            <div
              className={` w-10 h-10 flex justify-center items-center rounded-full ${theme.siteBackground} ${theme.inputBorder} border-solid border-2`}
            >
